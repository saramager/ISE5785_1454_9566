 ...
 * A point is immutable and defined by three coordinates (x, y, z).
 */
public class Point {
     ...
     * @return {@code true} if the object is a {@link Point} with the same coordinates, otherwise {@code false}
     */
    @Override
